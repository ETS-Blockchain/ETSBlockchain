    ...
    <header className="bg-linear-to-b from-red-600 to-transparent h-screen w-screen p-3 flex flex-col justify-between items-center overflow-hidden">
      ...
      <div className="flex flex-col items-center text-center px-6 gap-6">
        ...
        <div className="flex flex-col w-4/5 sm:flex-row sm:w-auto gap-3">
          <Link to="/mission" className="text-sm text-black bg-white py-2 px-5 rounded-lg hover:bg-gray-100 hover:scale-105 transition-all duration-150">
            {tx.mission}
          </Link>
          <Link to="/partenaires" className="text-sm text-white bg-black py-2 px-5 rounded-lg hover:bg-gray-900 hover:scale-105 transition-all duration-150">
            {tx.partner}
          </Link>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-3 pb-2 w-full max-w-3xl px-6">
        <Link to="/projets" className="flex-1 border border-white/15 rounded-xl p-4 flex flex-row items-center justify-center gap-3 hover:border-white/30 hover:bg-white/5 transition-all duration-200">
        ...
        {/* Liens externes : on garde <a> avec target="_blank" pour la sécurité */}
        ...
        <Link to="/contact" className="flex-1 border border-white/15 rounded-xl p-4 flex flex-row items-center justify-center gap-3 hover:border-white/30 hover:bg-white/5 transition-all duration-200">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="text-white/50 shrink-0">
