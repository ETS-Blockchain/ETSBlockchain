    ...
    <>
      ...
      <header className="relative bg-linear-to-b from-red-600 to-transparent h-screen w-screen p-3 flex flex-col justify-between items-center overflow-hidden">
        ...
        {floatingCryptos.map((crypto, i) => (
          ...
          >
            <img
              src={crypto.src === "bitcoin" ? Bitcoin : Ethereum}
              alt={crypto.alt}
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 pb-2 w-full max-w-3xl px-6 z-10">
          <Link to="/projets" className="flex-1 border border-white/15 rounded-xl p-2 sm:p-4 flex flex-row items-center justify-center gap-3 hover:border-white/30 hover:bg-white/5 transition-all duration-200">
          ...
          <Link to="/contact" className="flex-1 border border-white/15 rounded-xl p-2 sm:p-4 flex flex-row items-center justify-center gap-3 hover:border-white/30 hover:bg-white/5 transition-all duration-200">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="text-white/50 shrink-0">
